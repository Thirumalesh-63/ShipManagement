...
public class ShipController {
	...
	public ResponseEntity<List<Ship>> getAllShips(@RequestParam(defaultValue = "0") int page,
	...
	public ResponseEntity<Map<String, String>> deleteShip(@PathVariable int id) {
