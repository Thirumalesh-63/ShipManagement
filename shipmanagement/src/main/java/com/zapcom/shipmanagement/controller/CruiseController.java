...
public class CruiseController {
	...
	public ResponseEntity<List<Cruise>> getAllCruises(@RequestParam(defaultValue = "0") int page,
	...
	public ResponseEntity<Cruise> getCruiseByship(@PathVariable String shipname) {
		Cruise cruises = cruiseService.getByship(shipname);
	...
	public ResponseEntity<Map<String, String>> deleteCruise(@PathVariable int id) {
